...
5. `python3 scripts/fake-provider.py 3399 stub-key`, `python3 scripts/fake-stripe.py 3400 whsec_gate http://localhost:8080` and `python3 scripts/fake-btcpay.py 3401 whsec_gate http://localhost:8080` running in the background. The gates start nothing.
