...
Status: built and reviewed 2026-09-19, version 2 on `~wex` (desk revision 300, 45 unit tests, api-matrix 63 checks, page-smoke 13). The two contradictions the implementer found in Task 4 are corrected below in favour of the spec.
